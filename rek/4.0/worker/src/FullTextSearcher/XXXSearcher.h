...
public:
	 ...
	 */
	list< pair<string, float> > process1(const string& query, float weight, bool onPlace);
	list< pair<string, float> > processWithFilter(const string& query, const string& filter, float weight/* =1.0 */, bool onPlace);
