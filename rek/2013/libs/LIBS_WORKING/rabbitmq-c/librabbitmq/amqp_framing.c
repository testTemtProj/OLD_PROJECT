...
char const *amqp_constant_name(int constantNumber) {
  switch (constantNumber) {
    ...
    case AMQP_FRAME_OOB_METHOD: return "AMQP_FRAME_OOB_METHOD";
    case AMQP_FRAME_OOB_HEADER: return "AMQP_FRAME_OOB_HEADER";
    case AMQP_FRAME_OOB_BODY: return "AMQP_FRAME_OOB_BODY";
    case AMQP_FRAME_TRACE: return "AMQP_FRAME_TRACE";
    ...
    case AMQP_NOT_DELIVERED: return "AMQP_NOT_DELIVERED";
                       ...
                       void **decoded)
{
  ...
  switch (methodNumber) {
    ...
    case AMQP_CHANNEL_OPEN_OK_METHOD: {
      amqp_channel_open_ok_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
    ...
    case AMQP_FILE_QOS_OK_METHOD: {
      amqp_file_qos_ok_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
    ...
    case AMQP_FILE_STAGE_METHOD: {
      amqp_file_stage_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
    ...
    case AMQP_STREAM_QOS_OK_METHOD: {
      amqp_stream_qos_ok_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
    ...
    case AMQP_DTX_SELECT_METHOD: {
      amqp_dtx_select_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
    case AMQP_DTX_SELECT_OK_METHOD: {
      amqp_dtx_select_ok_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
    ...
    case AMQP_DTX_START_OK_METHOD: {
      amqp_dtx_start_ok_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
    ...
    case AMQP_TEST_CONTENT_METHOD: {
      amqp_test_content_t *m = NULL; /* no fields */
      *decoded = m;
      return 0;
    }
