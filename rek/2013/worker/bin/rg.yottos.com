<VirtualHost *:80>
    ...
    FastCgiServer /var/www/rg.yottos.com/cgi/getmyad-worker \
        ...
        -initial-env SERVER_ADDR=213.186.121.76 \
        ...
        -initial-env redis_category_host=127.0.0.1 \
        -initial-env redis_category_port=6384 \
        -initial-env redis_retargeting_host=127.0.0.1 \
        -initial-env redis_retargeting_port=6385 \
        -initial-env range_query=1.1 \
        ...
        -initial-env shortterm_expire=172800 \
        -initial-env views_expire=864000 \
        -initial-env context_expire=86400 \
    ...
    ScriptAlias /adshow_frame.fcgi /var/www/rg.yottos.com/cgi/getmyad-worker
    ScriptAlias /adshow_garant.fcgi /var/www/rg.yottos.com/cgi/getmyad-worker
</VirtualHost>
