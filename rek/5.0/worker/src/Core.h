...
public:
     ...
     */
	std::vector<Offer> getOffersRIS(const list<pair<pair<string, float>, pair<string, string>>> &offersIds, map< string,float > &offersRatingIds, const Params &params, const list<Campaign> &camps, bool &clean, bool &updateShort, bool &updateContext);
...
private:
	...
	void createVectorOffersByIds(const list<pair<pair<string, float>, pair<string, string>>> &offersIds, map< string,float > &offersRatingIds, vector<Offer> &result, const list<Campaign> &camps, const Params& params, bool &updateShort, bool &updateContext);
