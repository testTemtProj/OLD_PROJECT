...
XXXSearcher::XXXSearcher(const string& directoryName)
{
...
list< pair<string, float> > XXXSearcher::process1(const string& query, float weight/* =1.0 */)
{
...
// return list< pair<string, float> >();
	...
	//boost::posix_time::ptime startTime, endTime;//добавлено для замера времени.
	
	//startTime = boost::posix_time::microsec_clock::local_time();
	//RAMDirectory *dir = new RAMDirectory(directoryName.c_str());
	//endTime = boost::posix_time::microsec_clock::local_time();
	//LOG(INFO) << "время создания RAMDirectory = " << (endTime - startTime) << "\n";

	//IndexReader* reader = IndexReader::open(dir);
	///

	IndexReader* reader = IndexReader::open(directoryName.c_str());
...
*/
		...
		float g=1;
 		for (size_t i=0; i<k; i++)
 		{
 			...
 			//LOG(INFO) <<"Resultat "<< i << ". " << Misc::toString(doc->get(_T("guid"))) << " - " << g*weight << "\n";
 			doc->clear();
 		}
