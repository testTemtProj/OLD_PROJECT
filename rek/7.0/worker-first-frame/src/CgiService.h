...
private:
     ...
     */
    void Response(const char *out, int status, const char *content_type = "text/html");
     ...
     * \param cookie    Заголовок "Set-Cookie". Параметр передается в виде обертки Cookie
     */
    void Response(const std::string &out, int status, const char *content_type = "text/html");
