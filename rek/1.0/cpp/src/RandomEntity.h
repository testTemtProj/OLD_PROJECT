...
/** Класс, служащий для случайного выбора элементов с учётом их
...
public:
    ...
    /** Исключение, вызывается если была попытка выбрать случайную сущность
     *  из пустого списка.
     */
