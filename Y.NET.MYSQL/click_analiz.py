...
dbm = MySQLdb.connect(host="localhost", user="root", passwd="123qwe", db="key", charset='utf8', use_unicode=True)
dbm.set_character_set('utf8')
cur = dbm.cursor() 
