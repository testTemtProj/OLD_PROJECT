...
<asp:Panel ID="LogoCell" Visible="true" runat="server">
            <td style="width:154px;  border-left: #ffffff 1px solid;" valign="top">
                <asp:HyperLink ID="WebLogoHyperLink" runat="server" NavigateUrl="~/"> <asp:Image ID="TopImage" runat="server" Width="120" ImageUrl="~/img/Logo.gif" style="vertical-align:bottom; " />
                </asp:HyperLink>
            </td>
</asp:Panel>
                ...
                <table>
                    <tr>
                        ...
                        <td align="center" valign="middle" style="width: 116px" >
                            <asp:HyperLink ID="SettingsHyperLink" runat="server" Text="Настройки" NavigateUrl="~/Настройки" CssClass="settinglink"></asp:HyperLink></td>
                    </tr>
                    <tr>
                        <td>
                            <div id="divQueryBox"><asp:TextBox ID="QueryTextBox" runat="server" style="	width: 514px; height: 22px;	padding: 0;	margin: 0;	border: 1px solid #667; font-size: 10pt;	line-height: 25px;" /></div></td>
