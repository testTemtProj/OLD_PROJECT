	...
	function prepareUi() {
		...
		$("#tableAllAdvertise").jqGrid({
            datatype: function(postdata) {
				this.addJSONData(account_data.summaryReportData);
			},
            mtype: 'GET',
      ...
      //			height: 'auto',
		...
		$("#tableAccountMoneyOut").jqGrid({
            ...
            colModel: [
              ...
              { name: 'Summ', index: 'Summ', width: 100, align: 'center', sortable: false},
              { name: 'protectionCode', index: 'protectionCode', width: 100, align: 'center', sortable: false},
              { name: 'protectionDate', index: 'protectionDate', width: 100, align: 'center', sortable: false},
