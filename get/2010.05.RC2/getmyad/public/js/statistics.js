...
//			var link = '';
//			var row = {	'Title': domains[i], 'Action': link}
    ...
    $("#dialogCancelRequest").dialog({
        ...
        buttons: {
            "Да": function(){
                ...
                $.ajax({
                    url: "/private/moneyOutRemove?id=" + id,
...
var buttonApproveMoneyOutRequest = $("<input type='button' value='Отозвать заявку' style='height:20px;'/>");
buttonApproveMoneyOutRequest.attr('disabled', true).click(function() {					
	$("#dialogCancelRequest").dialog('open');
});		
$("#tableAccountMoneyOut").append(buttonApproveMoneyOutRequest);		
