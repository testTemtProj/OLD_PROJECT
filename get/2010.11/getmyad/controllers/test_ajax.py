...
class TestAjaxController(BaseController):
    ...
    def getdata(self):
        ...
        try:
            import urllib 
            URL = 'http://getmyad.vsrv-1.2.yottos.com/adshow.fcgi?scr=EDE791D1-901A-11DF-8EEC-0015175ECAD8&show=json'
            #URL = 'http://localhost/adshow.fcgi?scr=EDE791D1-901A-11DF-8EEC-0015175ECAD8&show=json&exclude=%s' % x 
            #LOCAL_PATH = 'd:/data.json' 
