...
function load_document(){
	...
	xclr = splitRGB($('#arrowColor').val());//splitRGB(document.getElementById('xcolor').style.backgroundColor);
	yclr = splitRGB($('#arrowBgColor').val());//splitRGB(document.getElementById('ycolor').style.backgroundColor);	
	var cr=2;
	var cg=2;
	var cb=2;
/*	
