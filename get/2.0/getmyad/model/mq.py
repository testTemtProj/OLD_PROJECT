...
class MQ(object):
    ...
    def campaign_start(self, campaign_id):
        ...
        ch.basic_publish(msg, exchange='indexator', routing_key='campaign.add')
        ch.close()
    ...
    def offer_delete(self, offer_Id, campaign_id):
        ...
        ch.basic_publish(msg, exchange='indexator', routing_key='advertice.update')
        ch.close()
    ...
    def offer_add(self, offer_Id, campaign_id):
        ...
        msg = 'Offer:%s,Campaign:%s' % (offer_Id, campaign_id)
        msg = amqp.Message(msg) 
        ch.basic_publish(msg, exchange='indexator', routing_key='advertice.delete')
        ch.close()
