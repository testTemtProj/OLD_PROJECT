...
class SphinxClient:
	def __init__ (self):
		...
		"""
		self._host			= config.get('sphinx_host', '127.0.0.1')		# searchd host (default is "localhost")
		self._port			= int(config.get('sphinx_port', 9312))			# searchd port (default is 9312)
		...
		self._limit			= 20000							# how much records to return from result-set starting at offset (default is 20)
		self._mode			= SPH_MATCH_EXTENDED2					# query matching mode (default is SPH_MATCH_ALL)
