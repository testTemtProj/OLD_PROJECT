...
namespace YottosCatalog {
    public class CatalogSiteMapProvider : SiteMapProvider {
        private YottosCatalogDataContext database = new YottosCatalogDataContext();
        ...
        public override SiteMapNode GetParentNode(SiteMapNode node) {
            ...
            else if (node.Url.Contains("CatalogDetails.aspx")) return new SiteMapNode(this, string.Empty, "CatalogList.aspx", Resources.CatalogResources.ToCatalogListLinkCaption, Resources.CatalogResources.ToCatalogListLinkCaption);             
